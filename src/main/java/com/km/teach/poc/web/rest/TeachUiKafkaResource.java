...
@RestController
@RequestMapping("/api/teach-ui-kafka")
public class TeachUiKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TeachUiKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public TeachUiKafkaResource(KafkaProperties kafkaProperties) {
